...
To start, let's see how people search for the word "flu" with gtrends(), and and then glimpse() it.
...
4. Compare interest in psychologist to psychiatrist over time, and create a line graph.  
5. Compare interest in psychologist to psychiatrist in google images over time, and create a line graph.  
6. Annotate the document and publish it to rpubs.com.
